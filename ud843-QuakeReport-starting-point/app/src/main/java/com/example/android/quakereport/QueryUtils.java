...
public final class QueryUtils {
    ...
    public static ArrayList<Earthquake> extractEarthquakes() {
        ...
        try{
            ...
            int size = jsonObject.getJSONArray("features").length();
            for(int i=0;i<size;i++){
                JSONObject obj=jsonObject.getJSONArray("features").getJSONObject(i).getJSONObject("properties");
                ...
                Earthquake earthquake = new Earthquake(mag,place,newDate);
            ...
            Log.e("QueryUtil.java","Can not read the JSONString");
        }
